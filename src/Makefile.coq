...
Makefile.coq.conf: _CoqProject.base
	coq_makefile -f _CoqProject.base -o Makefile.coq
...
VDFILE_FLAGS:=$(if _CoqProject.base,-f _CoqProject.base,) $(CMDLINE_COQLIBS) $(CMDLINE_VFILES)
